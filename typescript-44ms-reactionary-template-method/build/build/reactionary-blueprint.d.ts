...
type RequireEverythingExcept<T, K extends keyof T> = Required<Omit<T, K>> & Pick<T, K>;
export type FinalizedReactionaryBlueprint = RequireEverythingExcept<ReactionaryBlueprint, "reactingPower" | "serviceClient">;
export {};

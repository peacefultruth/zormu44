...
import { SourceOfTruthGracefulExit, SourceOfTruthPrimitiveExplorer } from "./source-of-truth";
...
export interface IAmReact {
    ...
    add_work: (ref: t44ms.Api.ref, my_buffered_callback: Work, work_description?: WorkDescription) => void;
